...
public class CLibrary {
    ...
    final public static Library LIBRARY = new Library("jlibpam", CLibrary.class);
    static {
        LIBRARY.load();
        init();
    }
    ...
    @JniField(flags={CONSTANT}, accessor="sizeof(long)")
    ...
    @JniMethod(cast="char *")
    public static final native long strdup(
            @JniArg(cast="char *") String s);
